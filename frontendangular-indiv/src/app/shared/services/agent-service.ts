...
export class AgentService {
  ...
  updateAgent(a: Agent, idAgent : number): Observable<Agent> {
    ...
    return this.httpClient.put<Agent>(this.apiURL+'/updateAgent/'+idAgent, a);
  }
  ...
  getAgentByLastName(LastNameAgent: string): Observable<Agent> {
    return this.httpClient.get<Agent>(this.apiURL+'/getAgentByLastName/'+LastNameAgent);

  }

  /////////////////////////DELETE/////////////////////

  deleteAgentById(idAgent: number) {
    return this.httpClient.delete<void>(this.apiURL+'/deleteAgent/'+idAgent)
  }
}
