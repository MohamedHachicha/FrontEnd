...
//////////////////////////////////////REQUEST CREDIT PER CUSTOMER///////////////////////////////////////////////////////
    ...
    requestCreditCustomer(c: Credit, idCustomerAccount : number): Observable<Credit> {
  
      return this.httpClient.post<Credit>(this.apiURL+'/request-credit-id/'+idCustomerAccount, c );
    }
...
/////////////////////////////////////////VERIFICATION CREDIT////////////////////////////////////////////
    ...
    refreshCredit(c: Credit, idCredit : number): Observable<Credit>  {
      ...
      return this.httpClient.put<Credit>(this.apiURL+'/update-credit/'+idCredit, c);
    }
//////////////////////////GET ALL CREDITS ////////////////////////
...
//////////////////////////GET CREDIT BY ID CREDIT/////////////////////////////
    retrieveCredit(idCredit: number): Observable<Credit> {
      return this.httpClient.get<Credit>(this.apiURL+'/retrieve-credit/'+idCredit);
  
    }
///////////////////GET ALL CREDITS BY ID CUSTOMER////////////////////////////////////

    retrieveCreditByCustomer(idCustomerAccount: number): Observable<Credit> {
      return this.httpClient.get<Credit>(this.apiURL+'/retrieve-credit-customer-id/'+idCustomerAccount);
...
///////////////////DELETE WITH CONTROL//////////////////////////////////
    ...
    suppCredit(idCredit: number) {
      return this.httpClient.delete<Credit>(this.apiURL+'/supp-credit/'+idCredit)
    }
////////////////////////////CLOSE CREDIT///////////////////////////////////////
