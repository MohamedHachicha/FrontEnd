...
export declare class AngularDropdownDirective implements OnChanges {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<AngularDropdownDirective, [null, { attribute: "id"; }]>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDeclaration<AngularDropdownDirective, "ng-dropdown,[ngDropdown],[ng-dropdown]", ["ngDropdown"], { "renderInPlace": "renderInPlace"; "calculatePosition": "calculatePosition"; "calculateInPlacePosition": "calculateInPlacePosition"; "disabled": "disabled"; "beforeOpen": "beforeOpen"; "beforeClose": "beforeClose"; "verticalPosition": "verticalPosition"; "horizontalPosition": "horizontalPosition"; }, { "onOpen": "open"; "onClose": "close"; }, ["control", "dropdownContent"]>;
}

//# sourceMappingURL=angular-dropdown.directive.d.ts.map